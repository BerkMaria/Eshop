...
class Pagination
{
    ...
    private $index = 'page';//ключ в которой пиш.ном.ст.
    ...
    private $current_page; //текущая ст.
    /**
     *
    ...
    private $limit; //количество записей на ст.
...
//     */
    ...
    public function __construct($total, $currentPage, $limit, $index)
    {
        ...
        $this->amount = $this->amount();//количество ст.
        # Устанавливаем номер текущей страницы
        $this->setCurrentPage($currentPage);//номер тек.стран.
    }
    /**
     *  Для вывода ссылок
     *
