...
class Product
{
    ...
    public static function createProduct($options)
    {
       ...
       $options = self::preparedate($options);
        // Соединение с БД
        $db = Db::getConnection();
    ...
    private static function preparedate(array $data)
    {
        $data['status'] = (int) $data['status'];
        $data['is_recommended'] = (int) $data['is_recommended'];
    ...
    public static function getImage($id)
    {
        ...
        $path = '/application/upload/images/products/';
    ...
    public static function getProductssListByCategory($categoryId, $page = 1)
    {
        $limit = Product::SHOW_BY_DEFAULT;
        // Смещение (для запроса)
        $offset = ($page - 1) * self::SHOW_BY_DEFAULT;
